...
if __name__ == '__main__':
    evalrank("/workspace/Image-Text_Retrieval/SGRAF-python3.6/runs10/f30k_SGR/checkpoint_7000/model_best.pth.tar",
             data_path='/workspace/Image-Text_Retrieval/datasets', split="test", fold5=True)
