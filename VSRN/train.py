...
def main():
    ...
    parser.add_argument('--vocab_path', default='/workspace/Image-Text_Retrieval/VSRN/vocab/',
    ...
    parser.add_argument('--logger_name', default='runs/run_VSRN',
    ...
    opt.logger_name = opt.logger_name + '_seed' + str(opt.seed) + '_' + time.strftime('%Y%m%d-%H-%M-%S',
                                                                                      time.localtime())
