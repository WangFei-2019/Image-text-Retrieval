...
def setup_seed(seed):  # 2022/01/21 10:58 增加随机种子，使得实验可复现
...
def main():
    ...
    parser.add_argument('--data_path', default='/workspace/Image-Text_Retrieval/datasets',  # default='./data/',
                        help='path to datasets')  # 2022/01/21 10:54 更改数据读取路径
    parser.add_argument('--data_name', default='coco',
                        help='{coco,f30k}_precomp')

    # ---------------------------------------------------------------#
    parser.add_argument('--seed', default=None, help='default: random')  # 2022/01/21 10:55 增加随机种子
    parser.add_argument('--cuda', default='0', help='default: random')  # 2022/01/21 10:55 增加GPU选取
    # ---------------------------------------------------------------#
    ...
    parser.add_argument('--logger_name', default='./runs10withh/{}_saem/log',
                        help='Path to save Tensorboard log.')
    parser.add_argument('--model_name', default='./runs10withh/{}_saem/checkpoint',
    ...
    if opt.seed is None:  # 2022/01/21 10:57 增加随机种子为文件命名
    ...
    setup_seed(opt.seed)  # 2022/01/21 10:57 增加随机种子，使得实验可复现
