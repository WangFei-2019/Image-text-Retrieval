...
def main():
    ...
    # ---------------------------------------------------------------#
    parser.add_argument('--seed', default=None, help='default: random')
    parser.add_argument('--cuda', default='0', help='default: random')
    # ---------------------------------------------------------------#

    parser.add_argument('--data_path', default='/workspace/Image-Text_Retrieval/vse++/data',
    ...
    parser.add_argument('--logger_name', default='runs/run_VSE',
    ...
    opt.logger_name = opt.logger_name.format(opt.data_name) + '_seed' + str(opt.seed)
    ...
    with open(opt.logger_name + '/setting.txt', 'w') as f:
