...
def evalrank(model_path, data_path=None, split='dev', fold5=False):
    ...
    if not fold5:
        ...
        results = []
        for i in range(5):
            r, rt0 = i2t(img_embs[i * 1000:(i + 1) * 1000],
                         cap_embs[i * 1000:(i + 1) * 1000],
                         measure=opt.measure,
                         return_ranks=True)
            print("Image to text: %.1f, %.1f, %.1f, %.1f, %.1f" % r)
            ri, rti0 = t2i(img_embs[i * 1000:(i + 1) * 1000],
                           cap_embs[i * 1000:(i + 1) * 1000],
                           measure=opt.measure,
                           return_ranks=True)
            if i == 0:
...
if __name__ == '__main__':
    ...
    #     print('*****************************')
    #     print((name + 2) * 1000)
    evalrank('/workspace/Image-Text_Retrieval/vse++/run_10_nFT/f30k_resnet_seed1000/model_best.pth.tar',data_path='/workspace/Image-Text_Retrieval/vse++/data', split='test', fold5=False)
