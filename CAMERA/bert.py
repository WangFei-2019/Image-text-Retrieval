...
class BERTSelfAttention(nn.Module):
    ...
    def transpose_for_scores(self, x):
        ...
        return x.permute(0, 2, 1, 3)    #(BS, num_head, num_word, head_size)    @@ qu
    ...
    def forward(self, hidden_states, attention_mask):
        ...
        context_layer = context_layer.permute(0, 2, 1, 3).contiguous()  #(BS, num_word, num_head, head_size)    @@ qu
        new_context_layer_shape = context_layer.size()[:-2] + (self.all_head_size,) #(BS, num_word, hidden_dim) @@ qu
